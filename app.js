// ===== Data =====
const SIGHT_WORDS = [ { word: 'the', hint: 'Most common word!', emoji: '' }, { word: 'and', hint: 'Joins two things', emoji: '' }, { word: 'a', hint: 'One of something', emoji: '1' }, { word: 'to', hint: 'Going somewhere', emoji: '' }, { word: 'is', hint: 'Something exists', emoji: '' }, { word: 'in', hint: 'Inside something', emoji: '' }, { word: 'it', hint: 'A thing nearby', emoji: '' }, { word: 'you', hint: 'The person reading!',emoji: '' }, { word: 'he', hint: 'A boy or man', emoji: '' }, { word: 'she', hint: 'A girl or woman', emoji: '' }, { word: 'was', hint: 'Happened before', emoji: '' }, { word: 'are', hint: 'More than one is', emoji: '' }, { word: 'at', hint: 'A place or time', emoji: '' }, { word: 'be', hint: 'To exist', emoji: '' }, { word: 'this', hint: 'Right here!', emoji: '' }, { word: 'have', hint: 'Own something', emoji: '' }, { word: 'from', hint: 'Where it started', emoji: '' }, { word: 'or', hint: 'A choice', emoji: '' }, { word: 'one', hint: 'The number 1', emoji: '' }, { word: 'had', hint: 'Owned before', emoji: '' }, { word: 'by', hint: 'Next to or made by',emoji: '' }, { word: 'but', hint: 'However', emoji: '' }, { word: 'not', hint: 'No, opposite', emoji: '' }, { word: 'all', hint: 'Every single one', emoji: '' }, { word: 'were', hint: 'They existed', emoji: '' }, { word: 'can', hint: 'Able to do it', emoji: '' }, { word: 'said', hint: 'Spoke words', emoji: '' }, { word: 'see', hint: 'Use your eyes', emoji: '' }, { word: 'get', hint: 'Go and get it', emoji: '' }, { word: 'like', hint: 'To enjoy', emoji: '' }, ];
const PHONICS_WORDS = [ { word: 'cat', chunks: ['c','at'], emoji: '' }, { word: 'dog', chunks: ['d','og'], emoji: '' }, { word: 'sun', chunks: ['s','un'], emoji: '' }, { word: 'hat', chunks: ['h','at'], emoji: '' }, { word: 'big', chunks: ['b','ig'], emoji: '' }, { word: 'red', chunks: ['r','ed'], emoji: '' }, { word: 'cup', chunks: ['c','up'], emoji: '' }, { word: 'pen', chunks: ['p','en'], emoji: '' }, { word: 'hop', chunks: ['h','op'], emoji: '' }, { word: 'mud', chunks: ['m','ud'], emoji: '' }, { word: 'ship', chunks: ['sh','ip'], emoji: '' }, { word: 'chin', chunks: ['ch','in'], emoji: '' }, { word: 'thin', chunks: ['th','in'], emoji: '' }, { word: 'when', chunks: ['wh','en'], emoji: '' }, { word: 'frog', chunks: ['fr','og'], emoji: '' }, { word: 'clap', chunks: ['cl','ap'], emoji: '' }, { word: 'snap', chunks: ['sn','ap'], emoji: '' }, { word: 'trip', chunks: ['tr','ip'], emoji: '' }, { word: 'blue', chunks: ['bl','ue'], emoji: '' }, { word: 'play', chunks: ['pl','ay'], emoji: '' }, { word: 'cake', chunks: ['c','a','ke'], emoji: '' }, { word: 'bike', chunks: ['b','i','ke'], emoji: '' }, { word: 'home', chunks: ['h','o','me'], emoji: '' }, { word: 'smile', chunks: ['sm','i','le'],emoji: '' }, ];
const SENTENCES = [ { text: 'The cat sat on the mat.', emoji: '' }, { text: 'A big red dog ran fast.', emoji: '' }, { text: 'She can see the blue sky.', emoji: '' }, { text: 'He had a hat and a bag.', emoji: '' }, { text: 'The sun is hot today.', emoji: '' }, { text: 'I like to eat cake.', emoji: '' }, { text: 'We can play and have fun.', emoji: '' }, { text: 'The frog can hop and jump.', emoji: '' }, { text: 'My dog likes to run and play.', emoji: '' }, { text: 'She said the bird can fly.', emoji: '' }, { text: 'He is not at home today.', emoji: '' }, { text: 'All the kids like to read.', emoji: '' }, { text: 'Can you see the big ship?', emoji: '' }, { text: 'The red bike is by the tree.', emoji: '' }, { text: 'You are a great reader!', emoji: '' }, ];
...
function updateHomeGreeting() {
  ...
  if (greetingEl && currentProfile) {
    greetingEl.textContent = 'Hi ' + currentProfile + '! ';
  }
}
...
if (_urlName) { currentProfile = _urlName; renderHome(); } else { renderProfilePicker(); }
